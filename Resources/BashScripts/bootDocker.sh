...
docker run --network=tf_containerlink_${userhandle[0]} --runtime=nvidia -v /home/teder/testArchiv/Mustererkennung_Job/UserContainerVolumes/${userhandle[0]}:/tensorflow/models/research/volume -itd --rm --name "tf_trainingcontainer_${userhandle[0]}" tf_trainingcontainer_student:latest
